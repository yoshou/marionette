...
int main(int argc, const char *argv[])
{
    ...
    if (marionette::preprocess::convert_tpose("../data/FullTrackingBone.fbx", "../data/DefaultPose.json") != 0)
    {
    ...
    if (marionette::preprocess::convert_tracking_model("../data/TrackingModel.fbx", "../data/TrackingModel.json") != 0)
    {
