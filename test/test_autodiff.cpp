...
TEST(AutoDiffTest, QuaternionRotationDual) {
  ...
  quat_t<dual_t<double>> q(dual_t<double>(1.0, 0.0), dual_t<double>(0.0, 0.0),
                           dual_t<double>(0.0, 0.0), dual_t<double>(0.0, 0.0));

  vec3_t<dual_t<double>> v(dual_t<double>(1.0, 0.0), dual_t<double>(0.0, 0.0),
...
TEST(AutoDiffTest, RotateAngleAxis) {
  ...
  // Test with dual_t<double> - rotation around z-axis with derivative
  {
    ...
    vec3_t<dual_t<double>> point(dual_t<double>(1.0, 0.0), dual_t<double>(0.0, 0.0),
                                 dual_t<double>(0.0, 0.0));
