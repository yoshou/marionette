...
void window_manager::exit() { should_close_flag.store(true); }
...
void window_base::on_close() { destroy(); }
...
void window_base::show() { window_manager::get_instance()->show_window(handle); }
...
graphics_context::~graphics_context() { detach(); }
