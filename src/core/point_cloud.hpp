...
struct point_cloud {
 ...
 private:
  typedef nanoflann::KDTreeSingleIndexAdaptor<
      nanoflann::L2_Simple_Adaptor<distance_type, point_cloud>, point_cloud, 3, /* dim */
      index_type>
      kd_tree_t;
 ...
 public:
  ...
  point_cloud() {}
  explicit point_cloud(const std::vector<point_type> &points) : points(points) {
    index = std::make_unique<kd_tree_t>(
        3 /*dim*/, *this, nanoflann::KDTreeSingleIndexAdaptorParams(1024 /* max leaf */));
  }
