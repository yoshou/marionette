...
point_cloud_debug_drawer::point_cloud_debug_drawer() : pimpl(new impl()) {}
...
void point_cloud_debug_drawer::clear() { pimpl->points.clear(); }

std::size_t point_cloud_debug_drawer::size() const { return pimpl->points.size(); }
