...
class residual_block {
 public:
  ...
  virtual std::size_t num_values() const { return 0; }
};
...
class auto_diff_residual_block : public residual_block {
  ...
  inline bool invoke_func(const T *params, T *values,
                          std::index_sequence<param_block_idxs...>) const {
 ...
 public:
  ...
  virtual std::size_t num_values() const override { return num_values_; }
  ...
  virtual bool jacobian(const double *params, std::size_t num_params, double *jac) const override {
    ...
    const auto grad_params = [this, num_params, jac,
...
class residual_vector {
 ...
 public:
  ...
  residual_vector(std::shared_ptr<Residuals>... residuals) : residuals{residuals...} {}
...
class least_square_problem {
 ...
 public:
  least_square_problem(const residual_vector &residuals) : residuals(residuals) {}
